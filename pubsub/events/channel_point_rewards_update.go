...
const CHANNEL_POINTS_REWARDS_UPDATE_EVENT = "channel.channel_points_custom_reward.update"

// A Channel PointRewardsUpdate Event.
// Sent when a channel points reward is updated
//
// Subscription name:
//
...
type ChannelPointRewardsUpdateEvent struct {
	ID int
...
type channelPointRewardsUpdateEventMeta struct {
	ID string `json:"id"`
...
func (c *ChannelPointRewardsUpdateEvent) UnmarshalJSON(b []byte) error {
	var m channelPointRewardsUpdateEventMeta
