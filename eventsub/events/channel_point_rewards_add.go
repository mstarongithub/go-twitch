...
type ChannelPointRewardsAddEvent struct {
	ID int
...
type channelPointRewardsAddEventMeta struct {
	ID string `json:"id"`
...
func (c *ChannelPointRewardsAddEvent) UnmarshalJSON(b []byte) error {
	var m channelPointRewardsAddEventMeta
